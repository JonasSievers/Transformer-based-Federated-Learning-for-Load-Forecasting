...
for idx, client in enumerate(smart_meter_names):
    ...
    model_evaluation_test = loadCompileEvaluateModel(
        path = cwd + f"/data/d05_models/3month/local/{client}/Local_LSTM_F5_H12/Round100",
    ...
    #CNN
    model_evaluation_test = loadCompileEvaluateModel(
        path = cwd + f"/data/d05_models/3month/local/{client}/Local_CNN_F5_H12/Round100",
        window = windows_dict[client][0], 
        MAX_EPOCHS = MAX_EPOCHS
    )
    #Save
    ...
    #Transformer
    model_evaluation_test = loadCompileEvaluateModel(
        path = cwd + f"/data/d05_models/3month/local/{client}/Local_Transformer_F5_H12/Round100",
        window = windows_dict[client][0], 
        MAX_EPOCHS = MAX_EPOCHS
    )
    #Save
...
for idx, client in enumerate(smart_meter_names):
    ...
    print("-----------------------", idx, "/32")
            ...
            #LSTM
    model_evaluation_test = loadCompileEvaluateModel(
        path = cwd + f"/data/d05_models/3month/local/{client}/Local_LSTM_F5_H24/Round100",
    ...
    #CNN
    model_evaluation_test = loadCompileEvaluateModel(
        path = cwd + f"/data/d05_models/3month/local/{client}/Local_CNN_F5_H24/Round100",
        window = windows_dict[client][1], 
        MAX_EPOCHS = MAX_EPOCHS
    )
    #Save
    ...
    #Transformer
    model_evaluation_test = loadCompileEvaluateModel(
        path = cwd + f"/data/d05_models/3month/local/{client}/Local_Transformer_F5_H24/Round100",
        window = windows_dict[client][1], 
        MAX_EPOCHS = MAX_EPOCHS
    )
    #Save
