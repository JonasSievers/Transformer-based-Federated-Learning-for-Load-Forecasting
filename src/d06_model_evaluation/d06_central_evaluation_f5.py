...
model_evaluation_test = loadCompileEvaluateModel(
    path = cwd + f"/data/d05_models/central/Central_LSTM_F5_H12/Round100",
    window = window_F5_H12, 
...
#CNN
model_evaluation_test = loadCompileEvaluateModel(
    path = cwd + f"/data/d05_models/central/Central_CNN_F5_H12/Round100",
    window = window_F5_H12, 
    MAX_EPOCHS = MAX_EPOCHS
)
#Save
...
#Transformer
model_evaluation_test = loadCompileEvaluateModel(
    path = cwd + f"/data/d05_models/central/Central_Transformer_F5_H12/Round100",
    window = window_F5_H12, 
    MAX_EPOCHS = MAX_EPOCHS
)
#Save
...
final_dict['Central']['LSTM']['H12']['F5'] = forecasts_dict_LSTM_F5_H12
final_dict['Central']['CNN']['H12']['F5'] = forecasts_dict_CNN_F5_H12
final_dict['Central']['Transformer']['H12']['F5'] = forecasts_dict_Transformer_F5_H12

with open(cwd + '/results/Central_results_H12_F5.pkl', 'wb') as f:
...
#LSTM
model_evaluation_test = loadCompileEvaluateModel(
    path = cwd + f"/data/d05_models/central/Central_LSTM_F5_H24/Round100",
    window = window_F5_H24, 
    MAX_EPOCHS = MAX_EPOCHS
)
#Save
forecasts_dict_LSTM_F5_H24 = {
...
#CNN
model_evaluation_test = loadCompileEvaluateModel(
    path = cwd + f"/data/d05_models/central/Central_CNN_F5_H24/Round100",
    window = window_F5_H24, 
    MAX_EPOCHS = MAX_EPOCHS
)
#Save
...
#Transformer
model_evaluation_test = loadCompileEvaluateModel(
    path = cwd + f"/data/d05_models/central/Central_Transformer_F5_H24/Round100",
    window = window_F5_H24, 
    MAX_EPOCHS = MAX_EPOCHS
)
#Save
...
#Inintialize result dictionary
final_dict = InititalizeResultDictionary(learning_style="Central")
final_dict['Central']['LSTM']['H24']['F5'] = forecasts_dict_LSTM_F5_H24
final_dict['Central']['CNN']['H24']['F5'] = forecasts_dict_CNN_F5_H24
final_dict['Central']['Transformer']['H24']['F5'] = forecasts_dict_Transformer_F5_H24

with open(cwd + '/results/Central_results_H24_F5.pkl', 'wb') as f:
    pickle.dump(final_dict, f)
