...
initiallySaveAllLocalModelsW168(cwd, smart_meter_names, local_LSTM_models, local_CNN_models, local_Transformer_models)
...
for idx, client in enumerate(smart_meter_names): 
    ...
    #Get local models
    local_LSTM_model, local_CNN_model, local_Transformer_model = loadLocalModelsW168( 
    ...
    saveLocalModelsW168(cwd, local_LSTM_model, local_CNN_model, local_Transformer_model, client)
