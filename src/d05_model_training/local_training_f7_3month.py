...
initiallySaveAllLocalModelsGeneral(cwd, '3month', smart_meter_names, local_LSTM_models, local_CNN_models, local_Transformer_models)
...
for idx, client in enumerate(smart_meter_names): 
    ...
    #Get local models
    local_LSTM_model, local_CNN_model, local_Transformer_model = loadLocalModelsGeneral( 
        cwd, '3month', local_LSTM_models, local_CNN_models, local_Transformer_models, idx, client
    )
    ...
    saveLocalModelsGeneral(cwd, '3month', local_LSTM_model, local_CNN_model, local_Transformer_model, client)
