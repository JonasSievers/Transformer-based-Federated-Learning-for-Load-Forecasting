...
initiallySaveAllGlobalModelsW168(cwd, global_LSTM_models, global_CNN_models, global_Transformer_models)
...
for idx_com, comm_round in enumerate(range(comms_round)):
    ...
    for idx, cluster in enumerate(windows_dict):
        ...
        #Get global models
        global_LSTM_model, global_CNN_model, global_Transformer_model = loadGlobalModelsW168( 
        ...
        #Save global models
        saveGlobalModelsW168(cwd, global_LSTM_models[idx], global_CNN_models[idx], global_Transformer_models[idx], idx, idx_com)
